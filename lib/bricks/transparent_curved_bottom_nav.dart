...
// No state included
class TransparentBtmNavBarCurved extends StatefulWidget {
  final Color primaryColor;
  final Color secondaryColor;
  final Color backgroundColor;

  TransparentBtmNavBarCurved(
      {this.primaryColor = ColorConstants.primaryColor,
      this.secondaryColor = ColorConstants.secondaryColor,
      Key? key})
  ...
  @override
  _TransparentBtmNavBarCurvedState createState() =>
      _TransparentBtmNavBarCurvedState();
}

class _TransparentBtmNavBarCurvedState
    extends State<TransparentBtmNavBarCurved> {
  //- - - - - - - - - instructions - - - - - - - - - - - - - - - - - -
